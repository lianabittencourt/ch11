...
start_date    = datetime(2024,9,18,0,0,0).strftime("%Y-%m-%dT%H:%M:%S") # use the datetime format YYYY-mm-ddTHH:MM:SS
end_date      = datetime(2024,9,27,0,0,0).strftime("%Y-%m-%dT%H:%M:%S")
response_type = 'json'
